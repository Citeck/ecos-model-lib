...
class PermsRulesTest : PermsEvaluatorTestBase() {
    ...
    fun test() {
        ...
        val recordId = "recId"
        addRecord(recordId, RecData("str-val", 123, 456.1, true))

        val perms0 = getPerms(recordId, createPermsDefWithRules(listOf(
                PermissionRule(
        ...
        val perms1 = getPerms(recordId, createPermsDefWithRules(listOf(
            PermissionRule(
                roles = setOf("initiator"),
